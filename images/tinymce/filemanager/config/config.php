...
$config = array(
	...
	*/
	...
	|
	*/
	'upload_dir' => str_replace('tinymce/filemanager/dialog.php', '', str_replace('\\', '/', $_SERVER['SCRIPT_FILENAME'])).'upload/editor/source/',
	...
	|
	*/
	'current_path' => '../../upload/editor/source/',
	...
	|
	*/
	'thumbs_base_path' => '../../upload/editor/thumbs/',
	...
	*/
	...
	'ext_file'                                => array( 'doc', 'docx', 'pdf', 'xls', 'xlsx', 'ppt', 'pttx'), //Files
...
if(@$_GET['multi'] != "" || $_GET['field_id'] == "gallery")
{
	@$_SESSION['RF']["multi"] = true;
}

if(@$_GET['is_nopath_file'] != "" && $_GET['popup'] == 1)
{
	@$_SESSION['RF']["is_nopath_file"] = $_GET['is_nopath_file'];
}

@$config['multi'] = $_SESSION['RF']["multi"];
if(@$_GET['popup'] == 1)
{
	@$config['is_nopath_file'] = $_SESSION['RF']["is_nopath_file"];
}
