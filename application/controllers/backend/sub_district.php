...
class Sub_district extends CI_Controller {
	...
	public function __construct()
    {
		...
		$this->smarty->assign('page_name', 'Sub District');
	...
	{	
		...
		$this->smarty->assign('region', $this->this_model->get_region());
	...
	public function get_province($region_id = '', $province_id = '')
	{
		$this->smarty->assign('province_id', $province_id);
		$this->smarty->assign('province', $this->this_model->get_province($region_id));
		$this->smarty->display('backend/'.$this->this_sub_page.'.tpl');
	}

	public function get_district($province_id = '', $district_id = '')
	{
		$this->smarty->assign('district_id', $district_id);
		$this->smarty->assign('district', $this->this_model->get_district($province_id));
		$this->smarty->display('backend/'.$this->this_sub_page.'.tpl');
	}
}