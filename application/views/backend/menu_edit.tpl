						...
						<form role="form" class="form-horizontal" name="add_edit" method="post" onsubmit="return check_data();">
							<div class="box-body">
									...
									<div class="col-sm-6">
										<select class="form-control" id="section_id" name="section_id">
		                                    ...
		                                    {foreach $section as $section_item}
		                                    	<option value="{$section_item.id}"{if $item.section_id == $section_item.id} selected="selected"{/if}>{$section_item.name}</option>
		                                    {/foreach}
		                                </select>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input class="form-control" type="text" name="controller" id="controller" value="{$item.controller}">
